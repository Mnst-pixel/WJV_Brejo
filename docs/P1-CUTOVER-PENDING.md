...
- Backend produtivo sem superuser; scopes mínimos efetivamente entregues a cada container; inventário MinIO/WordPress/plugins e validação de configurações reais.

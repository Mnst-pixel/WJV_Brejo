...
Metas quantitativas: `core/personal_goals.py` deriva o progresso dos fatos do titular por período. Migration0017 preserva metas manuais; o dashboard ignora objetivos atingidos/arquivados. Interface, contratos e limites em [P4-METAS.md](P4-METAS.md). Candidato sem deploy.

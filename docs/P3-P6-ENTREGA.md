...
| Flashcards pessoais e revisão | Criação/edição/agenda/histórico/arquivo, conflitos e recuperação | API/B/E2E real; imagem PostgreSQL em preparação | Não | Não se aplica ao texto privado | Imagem, grants reais e deploy | `P4-FLASHCARDS.md`, `test_personal_flashcards.py`, `flashcards.cjs` |

...
| Biblioteca e anotações privadas | Catálogo, criação, edição, busca, referência histórica e recuperação | API/B/E2E real; Linux em fechamento | Não | Não se aplica ao texto privado | Release, flashcards e demais recursos da biblioteca | `P4-ANOTACOES.md`, `test_personal_notes.py`, screenshot mobile |
